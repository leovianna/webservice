 ...
 * 
 */
@WebServiceClient(name = "EchoService", targetNamespace = "http://controle/", wsdlLocation = "http://localhost:10000/echo?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ECHOSERVICE_QNAME = new QName("http://controle/", "EchoService");
    ...
    public Echo getEchoPort() {
        return super.getPort(new QName("http://controle/", "EchoPort"), Echo.class);
    }
    ...
    public Echo getEchoPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://controle/", "EchoPort"), Echo.class, features);
    }
