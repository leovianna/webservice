...
public class ObjectFactory {
    ...
    private final static QName _Echo_QNAME = new QName("http://controle/", "echo");
    private final static QName _EchoResponse_QNAME = new QName("http://controle/", "echoResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://controle/", name = "echo")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://controle/", name = "echoResponse")
